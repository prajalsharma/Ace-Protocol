    ...
    pub strategy_whitelist: Vec<Pubkey>,
        ...
        <Section title="Judge Pitch" icon={Cpu}>
          <div className="space-y-3 text-sm text-gray-400 leading-relaxed">
            ...
            <p>
              ACE Protocol answers all three. It is a personal cashflow engine that sits on top of Solana&apos;s composable primitives: Hylo for yield, Jito for execution, Sphere for payment rails, and a policy-driven system accessible to users who have never touched a DeFi terminal.
            </p>
            <p>
              The technical novelty is the <strong className="text-white">execution-awareness layer</strong>: ACE doesn&apos;t just optimize yield, it optimizes the cost of executing financial actions. Every rebalance, every payout, and every harvest is routed through a live cost estimator that batches when beneficial and falls back gracefully when primary routes fail.
            </p>
            <p>
